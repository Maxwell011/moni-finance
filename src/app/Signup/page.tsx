    ...
    <>
      <div className='flex flex-col justify-center gap-1 mx-[41px] my-0 lg:absolute lg:-translate-x-2/4 lg:-translate-y-2/4 lg:left-2/4 lg:top-2/4'>
        ...
        <input
          ...
          className='w-full sm:w-36 h-10 sm:h-[41px] input-style lg:w-full'
        />
        ...
        <button className='inactive-btn flex justify-center items-center gap-4 text-base not-italic font-normal leading-[normal] p-3 rounded-[10px] sm:w-36 w-full mt-12 lg:w-full'>
          Sign Up
        </button>
      </div>
    </>
